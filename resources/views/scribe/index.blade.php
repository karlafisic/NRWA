...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://filmoteka.test";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="languages">
                    <a href="#languages">Languages</a>
                                ...
                                <a href="#languages-GETapi-languages">Dohvati sve jezike

Ova ruta vraća popis svih jezika u sustavu.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="languages-GETapi-languages--id-">
                                <a href="#languages-GETapi-languages--id-">Dohvati jedan jezik

Vraća podatke o jeziku prema zadanom ID-u.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="languages-POSTapi-languages">
                                <a href="#languages-POSTapi-languages">Dodaj novi jezik

Kreira novi jezik u sustavu.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="languages-PUTapi-languages--id-">
                                <a href="#languages-PUTapi-languages--id-">Ažuriraj postojeći jezik

Ažurira podatke o jeziku s navedenim ID-em.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="languages-DELETEapi-languages--id-">
                                <a href="#languages-DELETEapi-languages--id-">Obriši jezik

Briše jezik s određenim ID-em.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="bash-example">
    ...
    --get "http://filmoteka.test/api/user" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/hello" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-categories">Dohvati sve kategorije</h2>

<p>
</p>

<p>Vraća listu svih kategorija iz baze podataka.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/categories" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://filmoteka.test/api/categories"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-categories--id-">Dohvati određenu kategoriju</h2>

<p>
</p>

<p>Dohvaća kategoriju po ID-u.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/categories/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://filmoteka.test/api/categories/1"
);
...
<p>ID kategorije. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-categories">Dodaj novu kategoriju</h2>

<p>
</p>

<p>Sprema novu kategoriju u bazu podataka.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Naziv kategorije. Example: <code>Sportska</code></p>
        </div>
        </form>

                    <h2 id="endpoints-PUTapi-categories--id-">Ažuriraj kategoriju</h2>

<p>
</p>

<p>Ažurira naziv postojeće kategorije.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Znanstveno fantastična"
               data-component="body">
    <br>
<p>Novi naziv kategorije. Example: <code>Znanstveno fantastična</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-categories--id-">Obriši kategoriju</h2>

<p>
</p>

<p>Briše kategoriju iz baze podataka prema ID-u.</p>
...
<p>ID kategorije. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-countries">Dohvati sve države</h2>

<p>
</p>

<p>Vraća listu svih država iz baze podataka.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/countries" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://filmoteka.test/api/countries"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-countries--id-">Dohvati određenu državu</h2>

<p>
</p>

<p>Dohvaća podatke o državi prema ID-u.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/countries/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://filmoteka.test/api/countries/1"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID države. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-POSTapi-countries">Dodaj novu državu</h2>

<p>
</p>

<p>Sprema novu državu u bazu podataka.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="country"                data-endpoint="POSTapi-countries"
               value="Njemačka"
               data-component="body">
    <br>
<p>Naziv države. Example: <code>Njemačka</code></p>
        </div>
        </form>

                    <h2 id="endpoints-PUTapi-countries--id-">Ažuriraj državu</h2>

<p>
</p>

<p>Ažurira podatke o postojećoj državi prema ID-u.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="country"                data-endpoint="PUTapi-countries--id-"
               value="Austrija"
               data-component="body">
    <br>
<p>Novi naziv države. Example: <code>Austrija</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-countries--id-">Obriši državu</h2>

<p>
</p>

<p>Briše državu iz baze prema ID-u.</p>
...
<p>ID države. Example: <code>1</code></p>
                ...
                <h1 id="languages">Languages</h1>
                                ...
                                <h2 id="languages-GETapi-languages">Dohvati sve jezike

Ova ruta vraća popis svih jezika u sustavu.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/languages" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://filmoteka.test/api/languages"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="languages-GETapi-languages--id-">Dohvati jedan jezik

Vraća podatke o jeziku prema zadanom ID-u.</h2>
...
<span id="example-requests-GETapi-languages--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://filmoteka.test/api/languages/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://filmoteka.test/api/languages/16"
);
...
<span id="example-responses-GETapi-languages--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-languages--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-languages--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-languages--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-languages--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-languages--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-languages--id-" data-method="GET"
      data-path="api/languages/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-languages--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-languages--id-"
                    onclick="tryItOut('GETapi-languages--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-languages--id-"
                    onclick="cancelTryOut('GETapi-languages--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-languages--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-languages--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-languages--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-languages--id-"
               value="16"
               data-component="url">
    <br>
<p>ID jezika. Primjer: 1 Example: <code>16</code></p>
            </div>
                    </form>

                    <h2 id="languages-POSTapi-languages">Dodaj novi jezik

Kreira novi jezik u sustavu.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Naziv jezika. Primjer: Njemački Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="languages-PUTapi-languages--id-">Ažuriraj postojeći jezik

Ažurira podatke o jeziku s navedenim ID-em.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID jezika koji se ažurira. Primjer: 1 Example: <code>16</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Novi naziv jezika. Primjer: Talijanski Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="languages-DELETEapi-languages--id-">Obriši jezik

Briše jezik s određenim ID-em.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID jezika koji se briše. Primjer: 1 Example: <code>16</code></p>
            </div>
                    </form>
